...
fn main() {
    ...
    let earth_base_0 = Lch::new(15.0, 6.0, 50.0);
    let earth_base_8 = Lch::new(95.0, 9.0, 90.0);
    ...
    let earth_base_gradient: Vec<Lch> = Gradient::from([(0.0, earth_base_0), (1.0, earth_base_8)])
        .take(9)
        .map(|c| Lch::from_color(c))
        .collect();
